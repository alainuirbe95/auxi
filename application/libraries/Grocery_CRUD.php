...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
    ...
    foreach($fields as $field_num => $field)
    {
        ...
        $field_value = !empty($field_values) && isset($field_values->{$field->field_name}) 
        ...
        else
        {
            ...
            $field_input->input = call_user_func(
                $this->callback_add_field[$field->field_name], 
                $field_value, 
                null, 
                $field_info
            );
        ...
        switch ($field_info->crud_type) {
            case 'invisible':
                ...
                continue 2;  // changed from continue
            break;
...
protected function get_edit_input_fields($field_values = null)
{
    ...
    foreach ($fields as $field_num => $field)
    {
        ...
        else
        {
            ...
            $field_input = $field_info;
            $field_input->input = call_user_func(
                $this->callback_edit_field[$field->field_name],
                $field_value,
                $primary_key,
                $field_info,
                $field_values
...
protected function get_read_input_fields($field_values = null)
{
    ...
    // Mark read fields as readonly unless explicitly hidden via change_field_type
    ...
    foreach ($fields as $field_num => $field)
    {
        ...
        else
        {
            ...
            $field_input = $field_info;
            $field_input->input = call_user_func(
                $this->callback_read_field[$field->field_name],
                $field_value,
                $primary_key,
                $field_info,
                $field_values
