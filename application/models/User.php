...
class User extends MY_Model {
    ...
    public function recovery_password_change() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $this->_change_password(
                    $this->input->post('passwd'), $this->input->post('passwd_confirm'), set_value('user_identification'), set_value('recovery_code')
            );
        } else {
    ...
    public function get_unused_id() {
        // Create a random user id between 1000000000 and 4294967295 (max for int(10) unsigned)
        $random_unique_int = mt_rand(1000000000, 4294967295);
