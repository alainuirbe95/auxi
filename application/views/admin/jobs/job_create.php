                ...
                <div class="col-lg-10 col-xl-9 job-create-container">
                    <div class="modern-card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('admin/process_create_job'); ?>" method="post" id="jobCreateForm">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="<?php echo base_url('admin/jobs'); ?>" class="btn btn-modern btn-secondary w-100">
