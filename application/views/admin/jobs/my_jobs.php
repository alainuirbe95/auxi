        ...
        <div class="container-fluid">
            ...
            <div class="modern-header-section">
                <div class="header-content">
                    ...
                    <p class="page-subtitle">
                        Manage and monitor your own job listings
                    </p>
                </div>
            </div>
            ...
            <div class="modern-card">
                ...
                <div class="modern-filter-section">
                    <?php echo form_open('admin/my_jobs', array('method' => 'GET', 'id' => 'filterForm')); ?>
                    ...
                    <div class="filter-row">
                        ...
                        <div class="filter-actions">
                            ...
                            <a href="<?php echo base_url('admin/my_jobs'); ?>" class="btn btn-modern btn-outline">
                ...
                <div class="modern-table-container">
                    <?php if (empty($jobs)): ?>
                        <div class="empty-state">
                            ...
                            <a href="<?php echo base_url('admin/create_job'); ?>" class="btn btn-modern btn-primary">
                                <i class="fas fa-plus-circle mr-2"></i>
                        ...
                        <nav aria-label="Jobs pagination">
                            <ul class="pagination">
                                <?php if ($pagination['current_page'] > 1): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?php echo base_url('admin/my_jobs?' . http_build_query(array_merge($_GET, array('page' => $pagination['current_page'] - 1)))); ?>">
                                ...
                                ?>
                                    <li class="page-item <?php echo ($i == $pagination['current_page']) ? 'active' : ''; ?>">
                                        <a class="page-link" href="<?php echo base_url('admin/my_jobs?' . http_build_query(array_merge($_GET, array('page' => $i)))); ?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php endfor; ?>
