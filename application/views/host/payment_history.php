        ...
        <div class="col-12">
            <div class="page-header">
                <div class="header-content">
                    ...
                    <p class="page-subtitle">Track your closed jobs and payment information</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="summary-card">
                ...
                <div class="card-content">
                    ...
                    <p class="card-label">Jobs Completed</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <span class="text-muted ms-3">
                                    Showing <?php echo count($closed_jobs); ?> jobs
                                </span>
                            </div>
                        </div>
                    </form>
                                        ...
                                        <div class="job-info">
                                            ...
                                            <div class="job-meta">
                                                <span class="job-date">
                                                    ...
                                                    <?php echo $job->payment_released_at ? date('M j, Y', strtotime($job->payment_released_at)) : 'Date not available'; ?>
                                                </span>
